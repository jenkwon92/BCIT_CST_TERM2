/**
 * The driver program. Displays the specified arithmentic table with the
 * specifified start/stop values.
 * 
 */
public final class Main {
     ...
     *
     * @param argv the command line args. argv[0] - the type (+, - or *) argv[1] -
    ...
    /**
     * Convert the supplied string into an int. If the stri ng is not a valid int
     * then exit the program. To be valid the string must be an integer and be >
     ...
     */
    public static Shape getShape(final ShapeType type, final int width, final int height) {
        final Shape shape;
        try {
            switch (type) {
            case TRAINGLE: {
