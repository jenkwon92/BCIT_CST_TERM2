...
public class Main
{
	...
	*  @param ShapeType defines the type of shape to create 
	...
	**/
                                 ...
                                 final int       height)
    {
		...
		try{
			shape = ((Shape)Class.forName(type).getDeclaredConstructor(args).newInstance(width, height));
		}
	...
	*	@param String a single letter defining the shape
