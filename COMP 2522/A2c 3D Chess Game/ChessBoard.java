...
class ChessBoard extends Board  {
    ...
    @Override
    public void movePiece(int level, int stRow, int stCol, int desRow, int desCol) {
        // TODO Auto-generated method stub
        
    }

    @Override
    public Piece getPieceAt(int level, int row, int col) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override
    public void setPieceAt(int level, int row, int col, Piece piece) {
        // TODO Auto-generated method stub
        
    }

    @Override
    public void removePieceAt(int level, int row, int col) {
        // TODO Auto-generated method stub
