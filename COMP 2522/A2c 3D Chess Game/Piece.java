...
/**
 * Represents a generic chess piece. This class provides common functionality
 * and properties for all chess pieces. It's designed to be an abstract base
 * class, with specific chess pieces (like Pawn, Bishop, King, etc.) extending
 * it to provide piece-specific behaviors.
 * 
 * @author yongeun
 */
abstract class Piece {
    ...
    /**
     * Draws the chess piece on the chessboard. The color and symbol of the piece
     * are determined by its type and color (white or black).
     * 
    ...
    /**
     * Returns the symbol representing the piece. The specific symbol is determined
     * in subclasses (e.g., "P" for Pawn, "K" for King).
     * 
    ...
    /**
     * Checks if the piece can move in a 3D space from a starting position to a
     * destination position. The specific movement rules are defined in subclasses
     * (e.g., Pawn, King).
     * 
     * @param stRow    The starting row of the piece.
     * @param stCol    The starting column of the piece.
     * @param stLevel  The starting level of the piece.
     * @param desRow   The destination row for the piece.
     * @param desCol   The destination column for the piece.
     * @param desLevel The destination level for the piece.
     * @return true if the move is valid, false otherwise.
     */
    public abstract boolean canMove(int stRow, int stCol, int stLevel, int desRow, int desCol, int desLevel);
}
